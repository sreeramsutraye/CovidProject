...
export default function Profile() {
  ...
  const helpClicked = () => {
    alert("Please Contact to Mobile No: 8746454164 or Email: virat@gmail.com")
  }
  return (
        ...
        <View>
            ...
            <View style={styles.personalDetailsContainer}>
                <View style={styles.column1}>
                    ...
                    <TouchableOpacity onPress={helpClicked}><Text style={styles.profileText}>{<Ionicons name="md-help-circle" color="#013A63" size={20}></Ionicons>} Help</Text></TouchableOpacity>
